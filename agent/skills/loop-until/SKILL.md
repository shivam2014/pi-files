---
name: loop-until
description: Use for iterative delegation tasks with checkable completion criteria — loop with evaluate/iterate until criterion met, best-so-far rollback, budget governor
---
